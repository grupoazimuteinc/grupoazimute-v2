...
export default function AlgumaAjudaModalStyled() {
  ...
  return (
    <>
      <a
        onClick={openModal}
        className="button-default button-whatsapp cursor-pointer"
      >
        <svg className="mr-2" width="20" viewBox="0 0 24 24" fill="none">
