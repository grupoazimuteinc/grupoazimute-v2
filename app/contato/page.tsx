                            ...
                            <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Home-Copy" transform="translate(-875.000000, -543.000000)">
                                        <g id="Group" transform="translate(876.000000, 542.000000)" fill="#FFFFFF" fill-rule="nonzero" stroke="#FFFFFF" stroke-width="0.54">
                            ...
                            <svg width="28px" height="22px" viewBox="0 0 28 22" version="1.1">
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Home-Copy" transform="translate(-1279.000000, -546.000000)">
                                        <g id="Group" transform="translate(876.000000, 542.000000)" fill="#FFFFFF" fill-rule="nonzero">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-8">
                            <h2 className="borded">
                                Precisa falar conosco? <br />Deixe sua mensagem que retornaremos o mais breve possível.
                            </h2>
                        </div>
                        ...
                        <div className="col-12 col-md-8">
                            {/* <?php 
                                ...
                                if(isset($_POST['nome'])){
                                    ...
                                    $secret = '6Lf6KDslAAAAAB2eskpVajeszh-j7WSuzrVmg3rg';
                                    ...
                                    if($result->success == true) {
                                        ...
                                        switch($empresa){
                                            case "Engenharia":
                                                $callback = "https://www.azimuteengenharia.com.br/obrigado/contato";
                                                $retorno = "comercial@azimute.eng.br";
                                                break;
                                            case "Tech":
                                                $callback = "https://azimutetech.com.br/obrigado/contato";
                                                $retorno = "comercial@azimutetech.com.br";
                                                break;
                                            case "San":
                                                $callback = "https://azimutesan.com.br/obrigado/contato";
                                                $retorno = "comercial@azimutesan.com.br";
                                                break;
                                            case "Aria":
                                                $callback = "https://ariatecnologia.com.br/obrigado/contato";
                                                $retorno = "comercial@ariatecnologia.com.br";
                                                break;
                                            default:
                                                $slug = "";
                                                break;
                                        ...
                                        $headers .= "From: contato@grupoazimute.com.br\n";
                                        $emaildestinatario .= $retorno;
                                        $assunto = "Contato - Grupo Azimute";
                                        ...
                                        $emailsender = "contato@grupoazimute.com.br";
                                        ...
                                        header("Location: $pageurl/?send=ok");
                                    }
                                }
                            ?> */}
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-md-12">
                                        ...
                                        <div className="options-holder options-big" >
                                            ...
                                            <div className="option" data-value="Comercial">Comercial</div>
                                            <div className="option" data-value="RH">RH</div>
                                            <div className="option" data-value="Produção">Produção</div>
                                            <div className="option" data-value="Atendimento">Atendimento</div>
                                            <div className="option" data-value="Trabalho de Campo">Trabalho de Campo</div>
                                            <div className="option" data-value="Administrativo">Administrativo</div>
                                            <div className="option" data-value="Financeiro">Financeiro</div>
                                            <div className="option" data-value="Outra">Outra</div>
                                        </div>
                                    </div>
