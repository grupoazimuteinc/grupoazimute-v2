                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-8">
                            <h2 className="borded">
                                Complete seus dados abaixo para que possamos entrar em contato com você caso seu perfil se encaixe em alguma de nossas oportunidades.
                            </h2>
                        </div>
                            ...
                            <form onSubmit={ (e) => handleFormSubmit(e) } className="form-default" method="post" style={{ margin: 0 }}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-md-12">
                                        ...
                                        <div className="options-holder options-big" style={{display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gridGap: '14px'}}>
                                            <input type="hidden" name="area" value="" required />
                                            <div className="option" style={{marginBottom: 0}} data-value="Comercial">Comercial</div>
                                            <div className="option" style={{marginBottom: 0}} data-value="RH">RH</div>
                                            <div className="option" style={{marginBottom: 0}} data-value="Produção">Produção</div>
                                            <div className="option" style={{marginBottom: 0}} data-value="Atendimento">Atendimento</div>
                                            <div className="option" style={{marginBottom: 0}} data-value="Trabalho de Campo">Trabalho de Campo</div>
                                    ...
                                    <div className="col-12 col-md-12">
                                        <button type="submit" className="button-default" style={{position: 'relative'}}>Enviar currículo</button>
                                    </div>
                                </div>
                            </form> 
                        </div>
