    ...
    function handleChange(form: FormData) {
        ...
        setTimeout(async () => {
            try {
                ...
                if (!formData.name || !formData.email || !formData.linkedin || !formData.arquivo) {
                ...
                let errorMessage = 'Aconteceu algum erro ao enviar as informações'
                ...
                <div className="container smartphone:px-4">
                    <div className="row flex-col-reverse lg:flex-row">
                        ...
                        <div className="col-12 col-lg-6">
                            ...
                            >
                                {trabalheConoscoFormInputs.map((field, index) => {
