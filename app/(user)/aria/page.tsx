...
export default async function Aria() {
    ...
    return (
        <div className="aria-page">
            <StoriesVideoPlayer videos={['/videos/stories-site-grupo-azimute-aria.webm']} />
            <div className="content-interna">
                <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                    <Image src={ariaInterna} width={ 424 } height={ 110 } alt="" style={{ height: "auto" }} />
                    ...
                    <div className="infos-holder">
                        ...
                        <a href="mailto:comercial@ariatecnologia.com.br">
                            ...
                            <span>comercial@ariatecnologia.com.br</span>
                        </a>
                    </div>
                    ...
                    <div className="social-media">
                        ...
                        <div className="redes-sociais">
                            <a href="https://www.facebook.com/ariaimagemetecnologia" target="_blank">
                                <svg viewBox="0,0,256,256" width="24px" height="24px"><g fill="#e65c15" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{mixBlendMode: 'normal'}}><g transform="scale(10.66667,10.66667)"><path d="M17.525,9h-3.525v-2c0,-1.032 0.084,-1.682 1.563,-1.682h1.868v-3.18c-0.909,-0.094 -1.823,-0.14 -2.738,-0.138c-2.713,0 -4.693,1.657 -4.693,4.699v2.301h-3v4l3,-0.001v9.001h4v-9.003l3.066,-0.001z"></path></g></g></svg>
                            </a>

                            <a href="https://www.instagram.com/ariaimgtec/" target="_blank">
            ...
            <div className="container py-[60px] smartphone:py-[30px] smartphone:px-4">
                <div className="row">
                    ...
                    {/* Única linha - 3 serviços */}
                    <div className="row justify-content-center">
                        <div className="col-6 col-md">
                            <div className="box-icon">
                                <div className="icon-holder">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e65c15" viewBox="0 0 256 256"><path d="M173.66,98.34a8,8,0,0,1,0,11.32l-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35A8,8,0,0,1,173.66,98.34ZM232,128A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z"></path>
                                    </svg>
                                </div>
                                <span>Aerolevantamento e <br/> Topografia</span>

                                <p>Capture dados espaciais e acelere seus projetos</p>
                            </div>
                        </div>
                        ...
                        <div className="col-6 col-md">
                            <div className="box-icon">
                                ...
                                <span>Inspeções <br/> com Drone</span>

                                <p>Tecnologia mais avançada para ajudar na manutenção preventiva</p>
                            </div>
                        </div>
                        ...
                        <div className="col-6 col-md">
                            <div className="box-icon">
                                ...
                                <span>Escaneamento e <br/> Modelagem 3D</span>

                                <p>Garantindo a transformação digital de suas obras e otimizando o retrofit</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-5">
                            <h2>Tome as melhores decisões baseado em informações visuais e atualizadas</h2>
                            ...
                            <ul className="list-default smartphone:!mb-0">
                                ...
                                <li>Com mais informações melhores decisões.</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div className="container py-[60px] smartphone:py-[30px] smartphone:px-4">
                <div className="row">
                    <div className="col-12 col-md-6">
                        ...
                        <p>Agilidade de processo com drone permite  alta periodicidade de levantamentos, melhorando o acompanhamento e garantindo a segurança da operação</p>

                        <ul className="list-default">
                            <li style={{listStyle: 'none', marginLeft: '-17px'}}><strong>Monitoramento frequente permite</strong></li>
                            <li>Registro das mudanças do terreno e diário de obra;</li>
                            <li>Acompanhamento dos dutos de ventilação;</li>
                            <li>Estudo de escaneamento de fluidos;</li>
                            <li>Estimativa de vida útil do aterro.</li>
                        </ul>
                    </div>

                    <div className="col-12 col-md-6">
                        <h2>Melhore a gestão da sua planta de mineração com inteligência visual</h2>

                        <p>Através do acompanhamento periódico da área de extração é possível obter informações precisas sobre:</p>

                        <ul className="list-default">
                            <li style={{listStyle: 'none', marginLeft: '-17px'}}><strong>Gestão de suply chain</strong></li>
                            <li>Gestão de estoque de pilhas;</li>
                            <li>Inventário de produção;</li>
